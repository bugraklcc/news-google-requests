...
def scrape_world_news():
    ...
    try:
        if connection.open:
            ...
            for section in news_sections:
                ...
                if category_text == "Dünya":
                    ...
                    for i, (source, link, summary, date) in enumerate(
                        ...
                        news_item = {
                            "Category": "Dünya",  # Kategoriyi sabit olarak "Dünya" olarak ayarlayın
                            "Source": source_text,
                            "URL": news_url,
            ...
            result["Message"] = "Dünya haberleri başarıyla MySQL veritabanına eklenmiştir."
